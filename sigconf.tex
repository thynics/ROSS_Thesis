...
Table~\ref{tab:counterbalanced-baselines}(a) reports all five workloads and all four P-relative comparisons, rather than showing only the effective cases. P changes H's placement only on Cholesky and LU. It reduces scheduler-modeled copy from 128.55 to 24.41 GB on Cholesky (81.0\%) and from 148.77 to 90.98 GB on LU (38.8\%). The corresponding P/H speedups are 1.313x (range 1.296--1.324x) and 1.177x (1.171--1.186x); all six pairs agree in each case. This is positive evidence for the remedy when a prefix-admissible HEFT--MSI opportunity is observed, not a prevalence claim about the two benchmark names.
