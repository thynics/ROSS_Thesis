...
Table~\ref{tab:counterbalanced-baselines} isolates the two cases in which P changes H's placement. P reduces scheduler-modeled copy from 128.55 to 24.41 GB on Cholesky (81.0\%) and from 148.77 to 90.98 GB on LU (38.8\%). The corresponding P/H speedups are 1.313x (range 1.296--1.324x) and 1.177x (1.171--1.186x); all six pairs agree in each case. This is positive evidence for the remedy when a prefix-admissible HEFT--MSI opportunity is observed, not a prevalence claim about the two benchmark names.
...
FDTD, CG, and MiniWeather have identical H/P/N placement digests and modeled-copy totals. Their P/H ratios are 1.022x, 0.997x, and 1.000x; their P/N ratios are 1.002x, 0.998x, and 1.004x. These are timing controls, not locality effects. FDTD's six P/H ratios span 0.801--1.157x despite identical decisions, exposing the instability of this short interval. We therefore make neither locality-speedup nor universal non-regression claims from these observations.
